...
if (array_key_exists("DryShavers",$_COOKIE['product']))
  {

	$data=$_COOKIE['product'];

$new_value=$data['DryShavers']+1;
setcookie('product[DryShavers]',$new_value);

  }
else
  {

	setcookie('product[DryShavers]',1);
  }
}else{
	setcookie('product[DryShavers]',1);
}
...
if (array_key_exists("DryShavers",$_COOKIE['marketplace']))
  {

	$data=$_COOKIE['marketplace'];

$new_value=$data['DryShavers']+1;
setcookie('marketplace[DryShavers]',$new_value);

  }
else
  {

	setcookie('marketplace[DryShavers]',1);
  }
}else{
	setcookie('marketplace[DryShavers]',1);
}
	...
	<div id="divPageDescription">
			<div id="divAboutUs">
				<div id="divAboutUsDesc"> 
					<p id="pHeadingAboutUs">Dry Shavers</p>
...
<div class="row">
    <div class="col-md-4">
    <img src="images/products/product9/image1.jpeg" height="200px" width="200px">

    </div>
        <div class="col-md-4">
				<img src="images/products/product9/image2.png" height="200px" width="200px">
    	
    </div>
        <div class="col-md-4">
				<img src="images/products/product9/image3.png" height="200px" width="200px">
    	
    </div>
  </div>
<br/>
<br/>
<p>Get a shave that glides extremely smoothly over your skin. The rings with metallic pigments have an anti-friction coating for superb gliding with our best shaver.</p>
