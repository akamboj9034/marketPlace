		...
		<div id="divPageDescription">
			<div id="divAboutUs">
				<div id="divAboutUsDesc"> 
					...
					<p>goGlamrs is one-stop solution to all your beauty and wellness needs. We provide hassle free salon-like experience at the most comfortable place in the world - your home. Our team of professionally trained beauticians will provide you a comforting and pampering makeover session.<br/> 
We provide all the services ranging from haircut, spa, facials and makeup directly to you at any time you wish and make sure that your every demand and need regarding your beauty routine is taken care of whenever and wherever you want. 
</p>
				</div>
			</div>
			<div id="divHowItWorks">
				<div id="divHeadingHowItWorks"> 
					<p id="pHeadingHowItWorks">How It Works?</p>
					<div>
						<ul>
							<li id="liHowItWorks1">
								<img src="Pics/1.png" class="liHowItWorkImg"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<img src="Pics/Arrow2.png" class="liHowItWorkImgArrow"/>
								<div style="font-weight:500">
									<p class="liHowItWorksDescHeading">Select Services</p>
									<p class="liHowItWorksDescDesc">Choose from a wide range of beauty services offered</p>
								</div>
							</li>
							<li id="liHowItWorks2">
								<img src="Pics/2.png" class="liHowItWorkImg"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<img src="Pics/Arrow2.png" class="liHowItWorkImgArrow"/>
								<div style="font-weight:500">
									<p class="liHowItWorksDescHeading">Select Time & Location</p>
									<p class="liHowItWorksDescDesc">Tell us your desired location and time along with your contact details</p>
								</div>
							</li>
							<li id="liHowItWorks3" >
								<img src="Pics/3.png" class="liHowItWorkImg"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<img src="Pics/Arrow2.png" class="liHowItWorkImgArrow"/>
								<div style="font-weight:500">
										<p class="liHowItWorksDescHeading">Receive Confirmation</p>
										<p class="liHowItWorksDescDesc">Upon booking, you'll receive confirmation with relevant details</p>
								</div>
							</li>
							<li id="liHowItWorks4">
								<img src="Pics/4.png" class="liHowItWorkImg"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<div style="font-weight:500">
									<p class="liHowItWorksDescHeading">Enjoy the Experience</p>
									<p class="liHowItWorksDescDesc">Relax and enjoy the services at the comfort of your home</p>
								</div>
							</li>
						</ul>
					</div>
