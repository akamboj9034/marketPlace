...
if (array_key_exists("scrub",$_COOKIE['product']))
  {


	$data=$_COOKIE['product'];

$new_value=$data['scrub']+1;
setcookie('product[scrub]',$new_value);

  }
else
  {

	setcookie('product[scrub]',1);
  }
}else{
	setcookie('product[scrub]',1);
}
...
$curl = curl_init();
    ...
    $array1=array();
    $array1['email']='amitkamboj9034@gmail.com';
    $array1['companyName']='OneCall Pro';
    $array1['productName']='Ceiling';
    $data=json_encode($array1);


    curl_setopt_array($curl, array(
      CURLOPT_URL => "http://amitkamboj.com/add_track.php",
	...
	<div id="divPageDescription">
			<div id="divAboutUs">
				<div id="divAboutUsDesc"> 
					<p id="pHeadingAboutUs">Face Scrub</p>
...
<div class="row">
    <div class="col-md-4">
    <img src="images/products/product1/image2.png" height="200px" width="200px">

    </div>
        <div class="col-md-4">
				<img src="images/products/product1/image3.jpg" height="200px" width="200px">
    	
    </div>
        <div class="col-md-4">
				<img src="images/products/product1/image4.png" height="200px" width="200px">
