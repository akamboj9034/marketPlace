...
{
if (array_key_exists("Mascara",$_COOKIE['product']))
  {


	$data=$_COOKIE['product'];

$new_value=$data['Mascara']+1;
setcookie('product[Mascara]',$new_value);

  }
else
  {

	setcookie('product[Mascara]',1);
  }
}else{
	setcookie('product[Mascara]',1);
}
...
{
if (array_key_exists("Mascara",$_COOKIE['marketplace']))
  {
...
$new_value=$data['Mascara']+1;
setcookie('marketplace[Mascara]',$new_value);

  }
else
  {

	setcookie('marketplace[Mascara]',1);
  }
}else{
	setcookie('marketplace[Mascara]',1);
}
	...
	<div id="divPageDescription">
			<div id="divAboutUs">
				<div id="divAboutUsDesc"> 
					<p id="pHeadingAboutUs">Mascara</p>
...
<div class="row">
    <div class="col-md-4">
    <img src="images/products/product3/image2.jpg" height="200px" width="200px">

    </div>
        <div class="col-md-4">
				<img src="images/products/product3/image3.jpg" height="200px" width="200px">
    	
    </div>
        <div class="col-md-4">
				<img src="images/products/product3/image4.jpg" height="200px" width="200px">
    	
    </div>
  </div>
<br/>
<br/>
<p>Find the mascara for any lash need with the top mascara authority. Get plump, long lashes with mascara created in various formulas: lengthening mascara, volumizing mascara and defining mascara. You'll never need false lashes again!</p>
