...
{
if (array_key_exists("Lotions",$_COOKIE['product']))
  {


	$data=$_COOKIE['product'];

$new_value=$data['Lotions']+1;
setcookie('product[Lotions]',$new_value);

  }
else
  {

	setcookie('product[Lotions]',1);
  }
}else{
	setcookie('product[Lotions]',1);
}
...
{
if (array_key_exists("Lotions",$_COOKIE['marketplace']))
  {
...
$new_value=$data['Lotions']+1;
setcookie('marketplace[Lotions]',$new_value);

  }
else
  {

	setcookie('marketplace[Lotions]',1);
  }
}else{
	setcookie('marketplace[Lotions]',1);
}
	...
	<div id="divPageDescription">
			<div id="divAboutUs">
				<div id="divAboutUsDesc"> 
					<p id="pHeadingAboutUs">Lotions</p>
...
<div class="row">
    <div class="col-md-4">
    <img src="images/products/product4/image2.jpg" height="200px" width="200px">

    </div>
        <div class="col-md-4">
				<img src="images/products/product4/image3.jpg" height="200px" width="200px">
    	
    </div>
        <div class="col-md-4">
				<img src="images/products/product4/image1.jpg" height="200px" width="200px">
    	
    </div>
  </div>
<br/>
<br/>
<p>America's #1 Body Lotion leaves skin incredibly moisturized & lightly scented. Find it in your favorite exclusive Bath & Body Works fragrance today.</p>
