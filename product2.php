...
if (array_key_exists("Moisturizer",$_COOKIE['product']))
  {


	$data=$_COOKIE['product'];

$new_value=$data['Moisturizer']+1;
setcookie('product[Moisturizer]',$new_value);

  }
else
  {

	setcookie('product[Moisturizer]',1);
	}
}else{
	setcookie('product[Moisturizer]',1);
}
...
if (array_key_exists("Moisturizer",$_COOKIE['marketplace']))
  {
...
$new_value=$data['Moisturizer']+1;
setcookie('marketplace[Moisturizer]',$new_value);

  }
else
  {

	setcookie('marketplace[Moisturizer]',1);
  }
}else{
	setcookie('marketplace[Moisturizer]',1);
}
...
<div class="row">
    <div class="col-md-4">
    <img src="images/products/product2/image2.jpg" height="200px" width="200px">

    </div>
        <div class="col-md-4">
				<img src="images/products/product2/image3.jpg" height="200px" width="200px">
    	
    </div>
        <div class="col-md-4">
				<img src="images/products/product2/image4.jpg" height="200px" width="200px">
    	
    </div>
  </div>
<br/>
<br/>
<p>Tested and proven, Advanced Night Repair dramatically reduces the look of all key signs of aging. It maximizes the power of skin's natural nighttime renewal with the brand's exclusive ChronoluxCB™ Technology. It's also formulated with hyaluronic acid, nature's moisture magnet, to help lock in hydration. Lines and wrinkles look significantly reduced.</p>
