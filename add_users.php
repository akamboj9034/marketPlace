...
<div class="col-md-4">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="first_name" name="first_name" pattern="[A-Za-z0-9]{1,25}" maxlength="400" oninvalid="setCustomValidity('Please enter the address in valid format. Only digits and alphabets are allowed')" onchange="try{setCustomValidity('')}catch(e){}"  required>
            </div>
            <div class="form-group">
                <label for="last_name">Last name:</label>
                <input type="text" class="form-control" id="last_name" name="last_name"  pattern="[A-Za-z0-9]{1,25}" maxlength="400" oninvalid="setCustomValidity('Please enter the address in valid format. Only digits and alphabets are allowed')" onchange="try{setCustomValidity('')}catch(e){}" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="address" name="address" pattern="[A-Za-z0-9]{1,25}" maxlength="400" oninvalid="setCustomValidity('Please enter the address in valid format. Only digits and alphabets are allowed')" onchange="try{setCustomValidity('')}catch(e){}"  required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="cell_phone" name="cell_phone" required>
            </div>
...
$sql = "INSERT INTO users (firstname, lastname,email,address, home_phone,cell_phone)
