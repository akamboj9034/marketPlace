...
if (array_key_exists("Trimmers",$_COOKIE['product']))
  {


	$data=$_COOKIE['product'];

$new_value=$data['Trimmers']+1;
setcookie('product[Trimmers]',$new_value);

  }
else
  {

	setcookie('product[Trimmers]',1);
  }
...
if (array_key_exists("Trimmers",$_COOKIE['marketplace']))
  {
...
$new_value=$data['Trimmers']+1;
setcookie('marketplace[Trimmers]',$new_value);

  }
else
  {

	setcookie('marketplace[Trimmers]',1);
  }
	...
	<div id="divPageDescription">
			<div id="divAboutUs">
				<div id="divAboutUsDesc"> 
					<p id="pHeadingAboutUs">Trimmers</p>
...
<div class="row">
    <div class="col-md-4">
    <img src="images/products/product8/image1.jpeg" height="200px" width="200px">

    </div>
        <div class="col-md-4">
				<img src="images/products/product8/image2.jpg" height="200px" width="200px">
    	
    </div>
        <div class="col-md-4">
				<img src="images/products/product8/image3.jpg" height="200px" width="200px">
    	
    </div>
  </div>
<br/>
<br/>
<p>It features a strong 6,000 RPM motor with QuietStrokeTM technology that can handle coarse and curly hair without tugs and pulls and has rust-resistant, hygienic, replaceable ceramic blade module featuring SkinSafeTM technology to prevent nicks and snags.</p>
