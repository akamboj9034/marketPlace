...
{
if (array_key_exists("Straightner",$_COOKIE['product']))
  {


	$data=$_COOKIE['product'];

$new_value=$data['Straightner']+1;
setcookie('product[Straightner]',$new_value);

  }
else
  {

	setcookie('product[Straightner]',1);
  }
}else{
	setcookie('product[Straightner]',1);
}
...
{
if (array_key_exists("Straightner",$_COOKIE['marketplace']))
  {
...
$new_value=$data['Straightner']+1;
setcookie('marketplace[Straightner]',$new_value);

  }
else
  {

	setcookie('marketplace[Straightner]',1);
  }
}else{
	setcookie('marketplace[Straightner]',1);
}
	...
	<div id="divPageDescription">
			<div id="divAboutUs">
				<div id="divAboutUsDesc"> 
					<p id="pHeadingAboutUs">Hair Straightner</p>
...
<div class="row">
    <div class="col-md-4">
    <img src="images/products/product6/image1.jpg" height="200px" width="200px">

    </div>
        <div class="col-md-4">
				<img src="images/products/product6/image2.jpg" height="200px" width="200px">
    	
    </div>
        <div class="col-md-4">
				<img src="images/products/product6/image3.jpg" height="200px" width="200px">
    	
    </div>
  </div>
<br/>
<br/>
<p>Our exfoliator was created to be the best face scrub for men. Our SCRUB gets it done—simple, fast, effective! SCRUB is great for men with skin ranging from dry to oily. It’s also great for guys with sensitive skin because it’s fragrance free.</p>
