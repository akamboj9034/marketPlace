	...
	<body background="phoenix.jpg" style="padding:0;margin:0;background-attachment: fixed;background-repeat: no-repeat;">
		...
		<!--		<div id="divHeadingHowItWorks"> 
					...
					<div style="max-width:525px;width:100%;display:inline-block;margin-left:100px;">
							...
							<tr>
								<td> <br/>
									<input type="text" name="contact" pattern="[789][0-9]{9}" required maxlength="15" value="" placeholder="Contact No." id="discount" style="padding: 5px; border:0; border-bottom: 1px solid rgb(204,0,0);width:220px;font-size: 18px;font-family:Raleway;"/><br/>
								</td>
								<td></td>
								<td> <br/>
									<input type="text" name="address" value="" required placeholder="Address" id="discount" style="padding: 5px; border:0; border-bottom: 1px solid rgb(204,0,0);width:220px;font-size: 18px;font-family:Raleway;"/><br/>
								</td>
							</tr>
							<tr>
								<td> 
									<input type="text" name="city" value="" required placeholder="City" id="discount" style="padding: 5px; border:0; border-bottom: 1px solid rgb(204,0,0);width:220px;font-size: 18px;font-family:Raleway;"/><br/>
								</td>
								<td></td>
								<td> 
									<input type="date" name="date" required placeholder="Choose Date & Time" id="discount" style="padding: 5px; border:0; border-bottom: 1px solid rgb(204,0,0);width:220px;font-size: 18px;font-family:Raleway;"/><br/>
								</td>
							</tr>
							<tr>
								
								<td colspan="3"><button type="submit"  id="formbuttonSendMessage">Book Now</button></td>
								</tr>
							<tr>
                ...
                <div style="float:right;margin-right:30px;height:300px;overflow: auto;overflow-x:hidden;" >
                   <table border=0 cellpadding=30>
<tr><center><h1 style="border-bottom: 1px solid rgb(204,0,0);">Your cart</h1></center></tr>
...
$conn=mysql_query("select email FROM register WHERE email='$email' ");
if(mysql_num_rows($result)>0)
{echo"<th style='font-size:20px;text-align:center;'>S.no</th>";
echo"<th style='font-size:20px;text-align:center;'>Type </th>";
echo"<th style='font-size:20px;text-align:center;'>Rupees</th>";
...
echo "<tr>";
echo "<td style='text-align:center;'>";echo $row[0]; echo "</td>";
echo "<td style='text-align:center;'>";echo $row[2]; echo "</td>";echo "<td>";echo $row[4]; echo "</td>";


echo "<td style='text-align:center;'><a style='text-decoration:none;background-color:#4F7F8F;padding:10px;color:white;border-radius:5px;' href=delete.php?id=$id >Delete</a></td>";
