...
if (array_key_exists("HairColor",$_COOKIE['product']))
  {


	$data=$_COOKIE['product'];

$new_value=$data['HairColor']+1;
setcookie('product[HairColor]',$new_value);

  }
else
  {

	setcookie('product[HairColor]',1);
  }
...
if (array_key_exists("HairColor",$_COOKIE['marketplace']))
  {


	$data=$_COOKIE['marketplace'];

$new_value=$data['HairColor']+1;
setcookie('marketplace[HairColor]',$new_value);

  }
else
  {

	setcookie('marketplace[HairColor]',1);
  }
	...
	<div id="divPageDescription">
			<div id="divAboutUs">
				<div id="divAboutUsDesc"> 
					<p id="pHeadingAboutUs">Hair Color</p>
...
<div class="row">
    <div class="col-md-4">
    <img src="images/products/product7/image7.jpeg" height="200px" width="200px">

    </div>
        <div class="col-md-4">
				<img src="images/products/product7/image2.png" height="200px" width="200px">
    	
    </div>
        <div class="col-md-4">
				<img src="images/products/product7/image3.jpg" height="200px" width="200px">
    	
    </div>
  </div>
<br/>
<br/>
<p>This easy-to-use, no-mix gel formula comes ready to apply with its built-in applicator brush. Each application of the reusable formula conceals grays for 10+ washes. It's ammonia-free, peroxide-free, and worry-free hair color. Apply to your temples, roots, and hairline to extend the life of your color in minutes. Just brush, rinse, and go!</p>
