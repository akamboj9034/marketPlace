...
if (array_key_exists("Perfumes",$_COOKIE['product']))
  {

	$data=$_COOKIE['product'];

$new_value=$data['Perfumes']+1;
setcookie('product[Perfumes]',$new_value);

  }
else
  {

	setcookie('product[Perfumes]',1);
  }
}else{
	setcookie('product[Perfumes]',1);
}
...
if (array_key_exists("Perfumes",$_COOKIE['marketplace']))
  {

	$data=$_COOKIE['marketplace'];

$new_value=$data['Perfumes']+1;
setcookie('marketplace[Perfumes]',$new_value);

  }
else
  {

	setcookie('marketplace[Perfumes]',1);
  }
}else{
	setcookie('marketplace[Perfumes]',1);
}
	...
	<div id="divPageDescription">
			<div id="divAboutUs">
				<div id="divAboutUsDesc"> 
					<p id="pHeadingAboutUs">Perfumes</p>
...
<div class="row">
    <div class="col-md-4">
    <img src="images/products/product10/image1.jpg" height="200px" width="200px">

    </div>
        <div class="col-md-4">
				<img src="images/products/product10/image2.jpg" height="200px" width="200px">
    	
    </div>
        <div class="col-md-4">
				<img src="images/products/product10/image3.jpg" height="200px" width="200px">
    	
    </div>
  </div>
<br/>
<br/>
<p>Anti-Perspirant White Color For an odour protected style. Effortlesly A smoky and sweet scent with warm tobacco and amber notes refreshed with lemon and lime. Advanced Protection gives you a 48 hour odour-free style, effortlessly.</p>
