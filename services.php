		...
		<div id="divPageDescription">
			<div id="divAboutUs">
				<div id="divAboutUsDesc"> 
					<p id="pHeadingAboutUs">SERVICES</p>
...
<div class="container">
  <div class="row">
    <div class="col-md-4">
    	<a href="product1.php"><img src="images/products/product1/image3.jpg" height="200px" width="200px"><p>Face Scrubs</p></a>

    </div>
        <div class="col-md-4">
    	<a href="product2.php"><img src="images/products/product2/image3.jpg" height="200px" width="200px"><p>Moisturizer</p></a>
    	
    </div>
        <div class="col-md-4">
    		<a href="product3.php"><img src="images/products/product3/image3.jpg" height="200px" width="200px"><p>Mascara</p></a>
  ...
  <div class="row">
    <div class="col-md-4">
    	<a href="product4.php"><img src="images/products/product4/image3.jpg" height="200px" width="200px"><p>Lotions</p></a>

    </div>
        <div class="col-md-4">
    	<a href="product5.php"><img src="images/products/product5/image3.jpg" height="200px" width="200px"><p>After Shave</p></a>
    	
    </div>
        <div class="col-md-4">
    		<a href="product6.php"><img src="images/products/product6/image3.jpg" height="200px" width="200px"><p>Hair Straightner</p></a>
    ...
    <div class="row">
    <div class="col-md-4">
    	<a href="product7.php"><img src="images/products/product7/image3.jpg" height="200px" width="200px"><p>Hair Color</p></a>

    </div>
        <div class="col-md-4">
    	<a href="product8.php"><img src="images/products/product8/image3.jpg" height="200px" width="200px"><p>Trimmers</p></a>
    	
    </div>
        <div class="col-md-4">
    		<a href="product9.php"><img src="images/products/product9/image1.jpeg" height="200px" width="200px"><p>Dry shavers</p></a>
    ...
    <div class="row">
    <div class="col-md-4">
    	<a href="product10.php"><img src="images/products/product10/image1.jpg" height="200px" width="200px"><p>Perfumes</p></a>
...
<br/>
<br/>
<a href="lastvisited.php"> > Last 5 visited products</a><br/>
<a href="mostvisited.php"> > Most visited 5 products</a>
