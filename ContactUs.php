   ...
   <link rel="stylesheet" href="http://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.3.0/css/font-awesome.min.css">
	...
	<body background="phoenix.jpg" style="padding:0;margin:0;background-attachment: fixed;background-repeat: no-repeat;">
		...
		<div id="divPageDescription">
			...
			<center>
		<td >
	<span class="fa fa-envelope" style="color:white;font-size:30px;padding:10px;border-radius:50px;background-color:red;"></span>
		</td>
...
while(!feof($myfile)) {
	...
	<td style="color:white;">&nbsp<?php   echo fgets($myfile) ?> </td><br/>
