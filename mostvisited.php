		...
		<div id="divPageDescription">
			<div id="divAboutUs">
				<div id="divAboutUsDesc"> 
					<p id="pHeadingAboutUs">5 Most visited products</p>
...
{
	print("	<thead class='bold'><td>Product</td><td>Number of visits</td></thead>");
arsort($_COOKIE['product']);

foreach(array_slice($_COOKIE['product'],0,5) as $key=> $value)
{
