...
<div class="row">
<form  action="search_results.php" method="post" required>
    <div class="col-md-4">
    <label for="">Search by:</label>
                <div class="radio">
                <label><input type="radio" name="search_by" value="name" checked>name</label>
                </div>
                <div class="radio">
                <label><input type="radio"  value="email" name="search_by">email</label>
                </div>
                <div class="radio disabled">
                <label><input type="radio"  value="phone" name="search_by" >phone</label>
                </div>
    ...
    <div class="col-md-4">
                ...
                <button type="submit" class="btn btn-success full">Search User</button>
