...
{
if (array_key_exists("AfterShave",$_COOKIE['product']))
  {


	$data=$_COOKIE['product'];

$new_value=$data['AfterShave']+1;
setcookie('product[AfterShave]',$new_value);

  }
else
  {

	setcookie('product[AfterShave]',1);
  }
}else{
	setcookie('product[AfterShave]',1);
}
...
{
if (array_key_exists("AfterShave",$_COOKIE['marketplace']))
  {
...
$new_value=$data['AfterShave']+1;
setcookie('marketplace[AfterShave]',$new_value);

  }
else
  {

	setcookie('marketplace[AfterShave]',1);
  }
}else{
	setcookie('marketplace[AfterShave]',1);
}
	...
	<div id="divPageDescription">
			<div id="divAboutUs">
				<div id="divAboutUsDesc"> 
					<p id="pHeadingAboutUs">After shave</p>
...
<div class="row">
    <div class="col-md-4">
    <img src="images/products/product5/image1.jpg" height="200px" width="200px">

    </div>
        <div class="col-md-4">
				<img src="images/products/product5/image2.jpeg" height="200px" width="200px">
    	
    </div>
        <div class="col-md-4">
				<img src="images/products/product5/image3.jpg" height="200px" width="200px">
...
<br/>
<p>
The improved extra gentle formula was specially developed for men with sensitive skin. It’s very gentle and enriched with Vitamin E and natural, soothing Chamomile and Witch Hazel extracts. It leaves skin looking healthy and cared for and feeling comfortable and smooth.</p>
